const __vite__fileDeps=["./vega-embed.module.CVnlDOx4.js","./vega-tooltip.module.TMyZC--t.js","./2.DuStuoiw.js","./preload-helper.DpQnamwV.js","./stores.CSwS05ZX.js","./client.nqxrHBqa.js","../assets/2.BIquNXy_.css","./dsv.CKxpOsHB.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
...
import { B as Block, q as BlockTitle, S as Static } from "./2.DuStuoiw.js";
...
function instance($$self, $$props, $$invalidate) {
  ...
  async function load_chart() {
    ...
    if (!vegaEmbed) {
      vegaEmbed = (await __vitePreload(() => import("./vega-embed.module.CVnlDOx4.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6,7]) : void 0, import.meta.url)).default;
    }
