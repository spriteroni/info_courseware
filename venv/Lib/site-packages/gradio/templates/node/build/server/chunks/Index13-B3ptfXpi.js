...
import { B as Block, S as Static, f as BlockLabel, Q as Code$2, h as Empty, j as IconButton, z as Copy$1, D as DownloadLink, k as Download$1, i as IconButtonWrapper } from './2-DzB_itEN.js';
...
const lang_map = {
  python: () => import('./index29-Dc8SP3I5.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index30-C6kMAvMY.js'),
      import('./frontmatter-CFaxvTaK.js')
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => import('./index34-GMVs7TzS.js').then((m) => m.json()),
  html: () => import('./index31-7k4LHhva.js').then((m) => m.html()),
  css: () => import('./index32-D0grfzBe.js').then((m) => m.css()),
  javascript: () => import('./index33-BZYqOpSH.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index33-BZYqOpSH.js').then(
...
//# sourceMappingURL=Index13-B3ptfXpi.js.map
